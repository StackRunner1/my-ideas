...
- [ ] Create env: `conda create -n my-ideas python=3.12 -y`
- [ ] Activate env: `conda activate my-ideas`
...
- [x] Ask AI to create `backend/app/__init__.py`
- [x] Ask AI to create `backend/app/main.py` with:
  - [x] `FastAPI(title="my-ideas-api", version="0.1.0")`
  - [x] CORS allow `http://localhost:5173` and `http://127.0.0.1:5173`
  - [x] Middleware: `x-request-id` and `x-duration-ms`
...
- [ ] Ask AI to create `backend/app/__init__.py`
- [ ] Ask AI to create `backend/app/main.py` with:
